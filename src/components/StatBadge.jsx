export default function StatBadge({ value, label }) {
  return (
    <div 
      className="rounded-xl sm:rounded-2xl border border-lightest-navy/20 px-2.5 xs:px-3 sm:px-4 md:px-4 lg:px-4 xl:px-7 2xl:px-8 py-3 xs:py-3.5 sm:py-4 md:py-5 lg:py-6 xl:py-8 2xl:py-10 text-center shadow-lg h-full flex flex-col items-center justify-center min-h-[65px] xs:min-h-[75px] sm:min-h-[85px] md:min-h-[95px] lg:min-h-[110px] xl:min-h-[130px] 2xl:min-h-[140px] transition-all duration-300 hover:border-accent/40 hover:shadow-xl"
      style={{
